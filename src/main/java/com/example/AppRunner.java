...
public class AppRunner {
    public PullRequestProcessor initializePullRequestProcessor(String[] args) throws ParseException, URISyntaxException, IOException, InterruptedException {
    ...
    public void execute(String[] args) throws ParseException, URISyntaxException, IOException, InterruptedException {
